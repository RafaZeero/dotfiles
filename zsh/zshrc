...
# alias maza_invest="~/bin/./maza.sh"
# alias unreal="/home/zeero/Downloads/Linux_Unreal_Engine_5.0.3/Engine/Binaries/Linux/UnrealEditor"
alias obsidian="~/bin/./obsidian.sh"
alias l='ls -lah --group-directories-first'

# Personal Data
alias mei='echo 47225681000150'
...
# Custom Executables
alias onepay='~/bin/./onepay.sh'
alias arctos='~/bin/./arctos.sh'
alias voa='~/bin/./voa.sh'
alias go-hot-reload='~/bin/./go-hot-reload.sh'
alias zeero='~/bin/./zeero.sh'
